...
class Subscriptions {
    ...
    constructor() {
        this._storage = resource('subscriptions')
    }
    ...
    async addSubscription(identifier, subscription) {
        ...
        await this._storage.put(subscription.subscription_id, subscriptionModel)
    }
    ...
    async updateSubscription(subscription) {
        ...
        await this._storage.update(subscription.subscription_id, subscriptionModel)
    }
    ...
    async hasActiveSubscription(identifier, subscriptionPlanIds) {
        const { subscriptions } = await this._storage.queryAllBy([EQUALS('identifier', identifier), EQUALS_ANY_OF('subscription_plan_id', subscriptionPlanIds)])
    ...
    */
    ...
    async addSuccessfulPayment(payment) {
        ...
        await this._storage.update(payment.subscription_id, subscriptionModel)
    }
